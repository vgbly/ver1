const glossary = [
	...
	},
	{
		id: "A29",
		word: "cube",
		desc: "the result when a number is multiplied by itself twice. Designated by the exponent 3 (such as x<sup>3</sup>)."
	},
	{
		id: "A30",
		word: "cube root",
	...
	},
	{
		id: "A34",
		word: "discriminant",
		desc: "the value under the radical sign in the quadratic formula. [b<sup>2</sup> − 4ac]"
	},
	{
		id: "A35",
	...
	},
	{
		id: "A104",
		word: "square",
		desc: "the result when a number is multiplied by itself. Designated by the exponent 2 (such as x<sup>2</sup>)."
	},
	{
		id: "A105",
		word: "square root",
